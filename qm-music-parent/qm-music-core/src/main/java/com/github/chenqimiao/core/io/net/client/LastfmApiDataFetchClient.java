...
public class LastfmApiDataFetchClient implements MetaDataFetchApiClient {
    ...
    @Nullable
    @Override
    public com.github.chenqimiao.core.io.net.model.ArtistInfo fetchArtistInfo(String artistName) {
        ...
        com.github.chenqimiao.core.io.net.model.ArtistInfo result = new com.github.chenqimiao.core.io.net.model.ArtistInfo();
